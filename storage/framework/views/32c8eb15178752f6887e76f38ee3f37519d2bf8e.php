...
<form action="<?php echo e(route('rt.penduduk-sementara.update', $warga->id)); ?>" method="post">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="row">
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <div class="select2-wrapper w-100">
                                <select id="pemilik" name="id_pemilik" class="form-control select2-pemilik">
                                    ...
                                    <option value="<?php echo e($val->id); ?>" <?php echo e($val->id == $warga->pendudukSementara->id_pemilik_rumah ? 'selected' : ''); ?>><?php echo e($val->nama); ?></option>
                        ...
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <select class="form-control" name="status">
                                <option value="Kost" <?php echo e('Kost' == $warga->pendudukSementara->status ? 'selected' : ''); ?>>Kost</option>
                                <option value="Sewa" <?php echo e('Sewa' == $warga->pendudukSementara->status ? 'selected' : ''); ?>>Sewa</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/penduduk/penduduk_sementara/edit.blade.php ENDPATH**/ ?>