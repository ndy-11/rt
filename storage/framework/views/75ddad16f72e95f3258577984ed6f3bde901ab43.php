            ...
            <div class="card-body">
                <div class="form-row mb-4">
                    <div class="col-12 mb-4">
                        ...
                        <div class="w-100"></div>
                        <h5 class="text-dark"><?php echo e($warga->mutasi->status); ?></h5>
                    </div>
                    <div class="w-100"></div>
                    <div class="col-12 mb-4">
                        <label for="">Tanggal</label>
                        <div class="w-100"></div>
                        <h5 class="text-dark"><?php echo e($warga->mutasi->tgl_mutasi); ?></h5>
                    </div>
                </div>

                <a href="/rt/mutasi/<?php echo e($warga->id); ?>/edit" class="mr-2 btn btn-warning btn-pill text-white">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?php echo e(route('rt.mutasi.destroy', $warga->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6>
                        Anda akan <span class="text-dark">menghapus status Mutasi</span> untuk <?php echo e($warga->nama); ?> <br>
                    </h6>
                </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/penduduk/mutasi_warga/detail.blade.php ENDPATH**/ ?>