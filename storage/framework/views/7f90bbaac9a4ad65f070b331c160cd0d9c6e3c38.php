                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/rt/register/<?php echo e($val->id); ?>?jenis=keluar" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            <?php $no++; ?>
                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/rt/register/<?php echo e($val->id); ?>?jenis=masuk" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            <?php $no++; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/register/index.blade.php ENDPATH**/ ?>