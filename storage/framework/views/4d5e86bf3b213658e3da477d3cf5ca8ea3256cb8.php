    ...
    <div class="col-md-6 col-sm-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <a href="/rt/pemilu/<?php echo e($pemilu->id); ?>/edit" class="mr-2 btn btn-warning btn-pill text-white">
                    <i class="mdi mdi-circle-edit-outline"></i>
                    Edit
                </a>
                <?php if($undangan): ?>
                <a href="/rw/undangan-pemilu/<?php echo e($undangan->id); ?>" class="mr-2 btn btn-primary btn-pill text-white">
                    <i class="mdi mdi-circle-edit-outline"></i>
                    Edit Undangan
                </a>
                <?php else: ?>
            ...
            <div class="card-body">
                <div class="responsive-data-table">
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $calonRT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/pemilu/detail.blade.php ENDPATH**/ ?>