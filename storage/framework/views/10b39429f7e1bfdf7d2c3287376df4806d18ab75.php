    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-0">
            <li class="breadcrumb-item">
                <a href="/rt/rapat/<?php echo e($rapat->id); ?>">
...
<?php endif; ?>
<form id="form" method="POST" action="<?php echo e(route('rt.notulen.store')); ?>">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="id_rapat" value="<?php echo e($rapat->id); ?>">
    <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/rapat/notulen/create.blade.php ENDPATH**/ ?>