...
<form id="form" method="POST" action="<?php echo e(route('rt.inventaris.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-12">
            <?php if($errors->any()): ?>
                    ...
                    <div class="form-row mb-4">
                        <div class="form-check form-check-inline">
                            <label id="inventaris_barang_label" class="control control-radio checkbox-primary">Barang
                                <input type="radio" name="jenis_inventaris" id="inventaris_barang" value="Barang" <?php echo e((old('inventaris_barang') == 'Barang' || old('inventaris_barang') == '') ? 'checked' : ''); ?>>
                                <div class="control-indicator"></div>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label id="inventaris_perpustakaan_label" class="control control-radio checkbox-primary outlined ">Perpustakaan
                                <input type="radio" name="jenis_inventaris" id="inventaris_perpustakaan" value="Perpustakaan" <?php echo e((old('inventaris_barang') == 'Perpustakaan') ? 'checked' : ''); ?>>
                                <div class="control-indicator"></div>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label id="inventaris_tanah_bangunan_label" class="control control-radio checkbox-primary outlined ">Tanah Bangunan
                                <input type="radio" name="jenis_inventaris" id="inventaris_tanah_bangunan" value="Tanah Bangunan" <?php echo e((old('inventaris_barang') == 'Tanah Bangunan') ? 'checked' : ''); ?>>
                                <div class="control-indicator"></div>
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label id="inventaris_atk_label" class="control control-radio checkbox-primary outlined ">ATK
                                <input type="radio" name="jenis_inventaris" id="inventaris_atk" value="ATK" <?php echo e((old('inventaris_barang') == 'ATK') ? 'checked' : ''); ?>>
                                <div class="control-indicator"></div>
                            </label>
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/inventaris/create.blade.php ENDPATH**/ ?>