...
<?php endif; ?>
<form id="form" method="POST" action="<?php echo e(route('rw.undangan-pemilu.update', $undangan->id)); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-8 col-sm-12">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <textarea class="text-dark form-control mb-4" rows="8" id="summernote" name="content"><?php echo html_entity_decode($undangan->isi); ?></textarea>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rw/undangan_pemilu/edit.blade.php ENDPATH**/ ?>