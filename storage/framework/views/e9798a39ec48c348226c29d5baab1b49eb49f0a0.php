...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<?php echo e(asset('dist/front/assets/img/favicon/favicon.png')); ?>" type="image/png">

    <!-- Fontawesome -->
    <link type="text/css" href="<?php echo e(asset('vendor/@fortawesome/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet">

    <!-- Nucleo icons -->
    <link rel="stylesheet" href="<?php echo e(asset('vendor/nucleo/css/nucleo.css')); ?>" type="text/css">
    <!-- Prism -->
    <link type="text/css" href="<?php echo e(asset('vendor/prismjs/themes/prism.css')); ?>" rel="stylesheet">
    <!-- Front CSS -->
    <link type="text/css" href="<?php echo e(asset('css/front.css')); ?>" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="<?php echo e(asset('vendor/headroom.js/dist/headroom.min.js')); ?>"></script>

    <!-- Vendor JS -->
    <script src="<?php echo e(asset('vendor/onscreen/dist/on-screen.umd.min.js')); ?>"></script>
...
<?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/welcome.blade.php ENDPATH**/ ?>