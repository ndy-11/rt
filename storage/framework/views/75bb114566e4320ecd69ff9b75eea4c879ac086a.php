...
<form id="form" method="POST" action="<?php echo e(route('rw.inventaris.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-12">
            <?php if($errors->any()): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rw/inventaris/create.blade.php ENDPATH**/ ?>