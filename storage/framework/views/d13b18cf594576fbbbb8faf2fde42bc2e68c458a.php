            ...
            <div class="card-body">
                <div class="responsive-data-table">
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            <?php $no = 1; ?>
                            <?php $__currentLoopData = $aspirasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($no); ?></td>
                                <td><?php echo e($val->created_at); ?></td>
                                <td><?php echo e($val->bagian->nama_bagian); ?></td>
                                <td>
                                    <a class="btn btn-sm text-white btn-primary" href="/warga/aspirasi/<?php echo e($val->id); ?>">Lihat Aspirasi</a>
                                </td>
                            </tr>
                            <?php $no++; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/warga/aspirasi/index.blade.php ENDPATH**/ ?>