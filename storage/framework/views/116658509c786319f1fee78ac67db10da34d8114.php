...
<div class="breadcrumb-wrapper">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb p-0">
            ...
            <li class="breadcrumb-item">
                <a href="/rw/bagian/<?php echo e($bagian->id); ?>">
                    Data Pengurus
                </a>
            </li>
...
<form action="<?php echo e(route('rw.pengurus.store')); ?>" method="post">
    <?php echo csrf_field(); ?>
    <div class="row">
        <div class="col-12">
    ...
    <input type="hidden" name="id_bagian" value="<?php echo e($bagian->id); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rw/bagian/create-pengurus.blade.php ENDPATH**/ ?>