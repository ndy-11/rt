...
<?php endif; ?>
<form id="form" method="POST" action="<?php echo e(route('rt.pemilu.store')); ?>">
    <?php echo csrf_field(); ?>
    <div class="row">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/pemilu/create.blade.php ENDPATH**/ ?>