                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($val->nama_bagian); ?></td>
                                <td>
                                    <a class="btn btn-sm text-white btn-primary" href="/rw/bagian/<?php echo e($val->id); ?>">Detail</a>
                                </td>
                            </tr>
                            <?php $no++; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rw/bagian/index.blade.php ENDPATH**/ ?>