    ...
    <div class="col-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <a href="/rt/inventaris/<?php echo e($inventaris->id); ?>/edit?jenis=<?php echo e($jenis); ?>" class="mr-2 btn btn-warning btn-pill text-white">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?php echo e(route('rt.inventaris.destroy', $inventaris->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/inventaris/detail.blade.php ENDPATH**/ ?>