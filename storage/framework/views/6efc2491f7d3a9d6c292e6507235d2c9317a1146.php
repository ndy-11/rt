                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/rw/inventaris/<?php echo e($val->id); ?>?jenis=barang" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/rw/inventaris/<?php echo e($val->id); ?>?jenis=perpustakaan" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            <?php $no++; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($val->tgl_dimiliki); ?></td>
                                <td>
                                    <a href="/rw/inventaris/<?php echo e($val->id); ?>?jenis=tanah_bangunan" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            <?php $no++; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <table class="table dt-responsive nowrap data-table" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($val->tgl_dimiliki); ?></td>
                                <td>
                                    <a href="/rw/inventaris/<?php echo e($val->id); ?>?jenis=atk" class="btn btn-sm text-white btn-primary">Detail</a>
                                </td>
                            </tr>
                            <?php $no++; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rw/inventaris/index.blade.php ENDPATH**/ ?>