<ul class="nav sidebar-inner" id="sidebar-menu">
    <!-- RW MENU -->
    <?php if(isset(Auth::user()->tipe) && Auth::user()->tipe == 'RW'): ?>
    <li>
        <h6 class="px-4 py-2">Menu RW</h6>
    </li>
    <li class="has-sub <?php echo e(request()->is('rw/dashboard*') ? 'active' : ''); ?>">
        <a class="sidenav-item-link" href="/rw/dashboard">
            <i class="mdi mdi-home-account"></i>
            <span class="nav-text">Dashboard</span>
        </a>
    </li>
    <li class="has-sub <?php echo e(request()->is('rw/bagian*') ? 'active' : ''); ?>">
        <a class="sidenav-item-link" href="/rw/bagian">
            <i class="mdi mdi-office-building"></i>
            <span class="nav-text">Bagian</span>
        </a>
    </li>
    <li class="has-sub <?php echo e(request()->is('rw/penduduk*') ? 'active' : ''); ?>">
   ...
   <!-- <li class="has-sub <?php echo e(request()->is('rw/inventaris*') ? 'active' : ''); ?>">
    ...
    <li class="has-sub <?php echo e(request()->is('rw/tamu-kunjungan*') ? 'active' : ''); ?>">
    ...
    <li class="has-sub <?php echo e(request()->is('rw/register*') ? 'active' : ''); ?>">
    ...
    <li class="has-sub <?php echo e(request()->is('rt/dashboard*') ? 'active' : ''); ?>">
        <a class="sidenav-item-link" href="/rt/dashboard">
            <i class="mdi mdi-home-account"></i>
            <span class="nav-text">Dashboard</span>
        </a>
    </li>
    ...
    <li class="has-sub <?php echo e(request()->is('rt/tamu-kunjungan*') ? 'active' : ''); ?>">
        <a class="sidenav-item-link" href="/rt/tamu-kunjungan">
            <i class="mdi mdi-account-supervisor-circle"></i>
            <span class="nav-text">Tamu Kunjungan</span>
        </a>
    </li>
    <li class="has-sub <?php echo e(request()->is('rt/register*') ? 'active' : ''); ?>">
        <a class="sidenav-item-link" href="/rt/register">
            <i class="mdi mdi-email-outline"></i>
            <span class="nav-text">Register</span>
        </a>
    </li>
    <li class="has-sub <?php echo e(request()->is('rt/request*') ? 'active' : ''); ?>">
   ...
   <!--  <li class="has-sub <?php echo e(request()->is('rt/pemilu*') ? 'active' : ''); ?>">
    ...
    <li class="has-sub <?php echo e(request()->is('warga/pemilu*') ? 'active' : ''); ?>">
        <a class="sidenav-item-link" href="/warga/pemilu">
            <i class="mdi mdi-vote"></i>
            <span class="nav-text">Pemilu</span>
        </a>
    </li>
    <li class="has-sub <?php echo e(request()->is('warga/aspirasi*') ? 'active' : ''); ?>">
...
</ul><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/include/_sidebar.blade.php ENDPATH**/ ?>