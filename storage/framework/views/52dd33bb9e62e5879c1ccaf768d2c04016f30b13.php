            ...
            <div class="card-body">
                <div class="form-row mb-4">
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                        <label for="">NIK</label>
                        <div class="w-100"></div>
                        <h5 class="text-dark"><?php echo e($request->warga->nik); ?></h5>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                        <label for="">Nama</label>
                        <div class="w-100"></div>
                        <h5 class="text-dark"><?php echo e($request->warga->nama); ?></h5>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
                        <label for="">Alamat</label>
                        <div class="w-100"></div>
                        <h5 class="text-dark"><?php echo e($request->warga->alamat); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="form-row mb-4">
                    ...
                    <div class="col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="w-100"></div>
                        <h5 class="text-dark"><?php echo e($request->tipe_surat); ?></h5>
                    </div>
                    <div class="col-md-6 col-sm-12 mb-4">
                        <label for="">Status</label>
                        <div class="w-100"></div>
                        <h5 class="text-dark"><?php echo e($request->status_request); ?></h5>
                    </div>
                </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?php echo e(route('rt.request.update', $request->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/request_surat_kependudukan/detail.blade.php ENDPATH**/ ?>