    ...
    <div class="col-md-6 col-sm-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <a href="/rt/rapat/<?php echo e($rapat->id); ?>/edit" class="mr-2 btn btn-warning btn-pill text-white">
                ...
                <a href="/rt/notulen/create?id_rapat=<?php echo e($rapat->id); ?>" class="mr-2 btn btn-primary btn-pill text-white">
                    <i class="mdi mdi-circle-edit-outline"></i>
                    Buat Notulen
                </a>
            </div>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form action="<?php echo e(route('rt.rapat.destroy', $rapat->id)); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/rapat/detail.blade.php ENDPATH**/ ?>