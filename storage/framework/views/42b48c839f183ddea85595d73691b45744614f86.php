...
<?php $__env->startPush('custom-style'); ?>
    <style>
        .page-background {
            background-image: url("<?php echo e(asset('img/login-image.jpg')); ?>");
...
<div class="page-background" style="background-image: url('<?php echo e(asset('assets/img/login.jpg')); ?>');">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/dashboard/index.blade.php ENDPATH**/ ?>