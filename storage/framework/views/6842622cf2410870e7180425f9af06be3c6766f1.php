...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <form id="form" method="POST" action="<?php echo e(route('rw.bagian.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nama_rt" class="form-control" placeholder="Masukan Nama RT"
                                       id="inputGroupRT" required value="<?php echo e(old('nama_rt')); ?>">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-row col-lg-6 col-md-6 col-sm-12 mb-4">
                                ...
                                <input type="text" class="form-control" name="nik" id="inputNIK"
                                       placeholder="Masukan NIK" required value="<?php echo e(old('nik')); ?>">
                                <div class="valid-feedback">
                                    Bagus! NIK tersedia
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="form-row col-lg-6 col-md-6 col-sm-12 mb-4">
                                ...
                                <input type="text" class="form-control" name="no_kk" id="inputNoKK"
                                       placeholder="Masukan Nomor KK" required value="<?php echo e(old('no_kk')); ?>">
                                <div class="valid-feedback">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rw/bagian/create.blade.php ENDPATH**/ ?>