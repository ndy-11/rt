...
<form action="<?php echo e(route('rt.inventaris.update', $inventaris->id)); ?>" method="post">
    <?php echo csrf_field(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="kode_barang" value="<?php echo e($inventaris->kode_barang); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Nama Barang</label>
                            <input type="text" class="form-control" name="nama_barang" value="<?php echo e($inventaris->nama_barang); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Tanggal Perolehan Barang</label>
                            <input type="date" class="form-control" name="brg_tanggal_perolehan" value="<?php echo e($inventaris->tgl_perolehan); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <input type="number" class="form-control" name="brg_kuantitas" value="<?php echo e($inventaris->kuantitas); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Satuan</label>
                            <input type="text" class="form-control" name="brg_satuan" value="<?php echo e($inventaris->satuan); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" name="brg_harga" value="<?php echo e($inventaris->harga); ?>">
                            </div>
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-6 col-md-6 col-sm-12 mb-4">
                            <label>Keterangan Barang</label>
                            <textarea type="text" class="form-control" rows="2" name="brg_keterangan" value="<?php echo e($inventaris->keterangan); ?>"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="kode_buku" value="<?php echo e($inventaris->kode_buku); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Judul Buku</label>
                            <input type="text" class="form-control" name="judul_buku" value="<?php echo e($inventaris->judul); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Pengarang Buku</label>
                            <input type="text" class="form-control" name="pengarang_buku" value="<?php echo e($inventaris->pengarang); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Penerbit Buku</label>
                            <input type="text" class="form-control" name="penerbit_buku" value="<?php echo e($inventaris->penerbit); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Tahun Terbit</label>
                            <input type="number" class="form-control" name="tahun_terbit_buku" value="<?php echo e($inventaris->tahun_terbit); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Tanggal Perolehan Buku</label>
                            <input type="date" class="form-control" name="buku_tanggal_perolehan" value="<?php echo e($inventaris->tgl_dimiliki); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Kuantitas</label>
                            <input type="number" class="form-control" name="brg_kuantitas" value="<?php echo e($inventaris->jumlah_buku); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="kode_tanah" value="<?php echo e($inventaris->kode_tanah); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Tanggal Perolehan Tanah</label>
                            <input type="date" class="form-control" name="tanah_tanggal_perolehan" value="<?php echo e($inventaris->tgl_dimiliki); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Kelengkapan Dokumen</label>
                        ...
                        <div class="form-row col-md-8 col-sm-12 mb-4">
                            <label>Alamat</label>
                            <textarea rows="2" class="form-control" name="tanah_alamat"><?php echo e($inventaris->alamat); ?></textarea>
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Asal</label>
                        ...
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Luas</label>
                            <input type="number" class="form-control" name="tanah_luas" value="<?php echo e($inventaris->luas); ?>">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="kode_atk" value="<?php echo e($inventaris->kode_atk); ?>">
                        </div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Nama ATK</label>
                            <input type="text" class="form-control" name="nama_atk" value="<?php echo e($inventaris->nama_atk); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Tanggal Perolehan ATK</label>
                            <input type="date" class="form-control" name="atk_tanggal_perolehan" value="<?php echo e($inventaris->tgl_dimiliki); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Kelengkapan Dokumen</label>
                        ...
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
                            <label>Kuantitas</label>
                            <input type="number" class="form-control" name="atk_kuantitas" value="<?php echo e($inventaris->jumlah); ?>">
                        </div>
                        <div class="w-100"></div>
                        <div class="form-row col-lg-4 col-md-6 col-sm-12 mb-4">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/sandy/01D8523B2AAE3E401/Rest In Peace/Project/sirt-web/resources/views/pages/rt/inventaris/edit.blade.php ENDPATH**/ ?>