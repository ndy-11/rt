<ul class="nav sidebar-inner" id="sidebar-menu">
    <!-- RW MENU -->
    @if(isset(Auth::user()->tipe) && Auth::user()->tipe == 'RW')
    <li>
        <h6 class="px-4 py-2">Menu RW</h6>
    </li>
    <li class="has-sub {{ request()->is('rw/dashboard*') ? 'active' : '' }}">
   ...
   <li class="has-sub {{ request()->is('rw/inventaris*') ? 'active' : '' }}">
    ...
    @endif
    <!-- RT MENU -->
    @if(isset(Auth::user()->tipe) && Auth::user()->tipe == 'RT')
    <li>
        <h6 class="px-4 py-2">Menu RT</h6>
    </li>
    <li class="has-sub {{ request()->is('rt/dashboard*') ? 'active' : '' }}">
        <a class="sidenav-item-link" href="/rt/dashboard">
            <i class="mdi mdi-home-account"></i>
            <span class="nav-text">Dashboard</span>
        </a>
    </li>
    <li class="has-sub {{ request()->is('rt/grafik*') ? 'active' : '' }}">
        <a class="sidenav-item-link" href="/rt/grafik">
            <i class="mdi mdi-account-box-multiple"></i>
            <span class="nav-text">Grafik</span>
        </a>
    </li>
        <li class="has-sub {{ request()->is('rt/tambah_warga*') ? 'active' : '' }}">
        <a class="sidenav-item-link" href="/rt/tambah_warga/create">
            <i class="mdi mdi-account-box-multiple"></i>
            <span class="nav-text">Tambah Warga</span>
        </a>
    </li>
        <li class="has-sub {{ request()->is('rt/master-data*') || request()->is('rt/mutasi*') ? 'active' : '' }}">
