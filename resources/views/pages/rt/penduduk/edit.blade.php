    ...
    <form id="form" method="POST" action="{{ route('rt.penduduk.update', $data->id) }}">
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                ...
                <div class="form-section">
                    <div class="form-section-title"><i class="mdi mdi-home"></i> Alamat KTP</div>
                    <div class="row">
                        <div class="form-group col-lg-6 mb-3">
                ...
                <div class="form-section tinggal">
                    <div class="form-section-title"><i class="mdi mdi-home-modern"></i> Alamat Tinggal</div>
                    <div class="row">
                        <div class="form-group col-lg-6 mb-3 tinggal">
                            <label class="form-label">Provinsi</label>
                            <div class="w-100"></div>
                            <div class="select2-wrapper w-100">
                        ...
                        <div class="w-100"></div>
                        <div class="form-group col-lg-12 mb-3 tinggal">
                            <label class="form-label">Alamat Jalan</label>
                            <textarea class="form-control mb-2" rows="2" placeholder="Masukan Alamat"
