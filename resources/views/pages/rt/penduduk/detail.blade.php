            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        ...
                        <div class="detail-value">{{$warga->nama}}</div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Jenis Kelamin</div>
                        <div class="detail-value">
                            @if($warga->jkel == "P" || strtolower($warga->jkel) == "perempuan")
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        ...
                        <div class="detail-value">{{$warga->tgl_lahir}}</div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Nomor Induk Penduduk</div>
                        <div class="detail-value">{{$warga->nik}}</div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Nomor Kartu Keluarga</div>
                        <div class="detail-value">{{$warga->no_kk}}</div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">RT / RW</div>
                        <div class="detail-value">{{$warga->no_rt}} / {{$warga->no_rw}}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        ...
                        <div class="detail-value">{{$warga->agama}}</div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Status Kawin</div>
                        <div class="detail-value">{{$warga->status_kawin ?? '-'}}</div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Pendidikan</div>
                        <div class="detail-value">{{$warga->pendidikan}}</div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Pekerjaan</div>
                        <div class="detail-value">{{$warga->pekerjaan}}</div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Kewarganegaraan</div>
                        <div class="detail-value">{{$warga->kewarganegaraan ?? '-'}}</div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 mb-3">
                        <div class="detail-label">Kedudukan Keluarga</div>
                        <div class="detail-value">{{$warga->kedudukan_keluarga ?? '-'}}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3">
                        ...
                        <div class="detail-value">{{$warga->alamat_ktp}}</div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 mb-3">
                        <div class="detail-label">Alamat Tinggal</div>
                        <div class="detail-value">{{$warga->alamat}}</div>
                    </div>
                </div>
            </div>
        </div>
