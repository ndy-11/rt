        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="form-section">
                    <div class="form-section-title"><i class="mdi mdi-account-box"></i> Data Pribadi</div>
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6 mb-3">
                            <label class="form-label">NIK (Nomor Induk Penduduk)</label>
                            <div class="input-group">
                            ...
                            <div class="valid-feedback">Bagus! NIK tersedia</div>
                            <div class="invalid-feedback">Maaf, sudah ada warga dengan NIK sama</div>
                        </div>
                        <div class="form-group col-lg-6 mb-3">
                        ...
                        <div class="form-group col-lg-6 mb-3">
                            ...
                            <ul class="list-unstyled list-inline mb-0">
                                <li class="d-inline-block mr-3 custom-radio">
                        ...
                        <div class="form-group col-lg-6 mb-3">
                            <label class="form-label">Kedudukan Keluarga</label>
                            <div class="w-100 mb-2"></div>
                            <ul class="list-unstyled list-inline mb-0">
                                <li class="d-inline-block mr-3 custom-radio">
                ...
                <div class="form-section">
                    <div class="form-section-title"><i class="mdi mdi-map-marker"></i> Alamat KTP</div>
                    <div class="row">
                        <div class="form-group col-lg-6 mb-3">
                ...
                <div class="form-section">
                    <label class="control outlined control-checkbox checkbox-primary custom-checkbox">
                        Apakah alamat KTP sama dengan alamat tinggal ?
                        <input id="alamat-sama" name="alamat_sama" type="checkbox"/>
                        <div class="control-indicator"></div>
                    </label>
                </div>
                <div class="form-section tinggal">
                    <div class="form-section-title"><i class="mdi mdi-map-marker-radius"></i> Alamat Tinggal</div>
                    <div class="row">
                        <div class="form-group col-lg-6 mb-3">
                            <label class="form-label">Provinsi</label>
                ...
                <button type="submit" class="btn btn-primary btn-lg mt-2"><i class="mdi mdi-plus-circle"></i> Tambah Data</button>
            </div>
        </div>
    </form>
@endsection
