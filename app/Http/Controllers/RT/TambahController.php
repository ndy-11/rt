...
class TambahController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('pages.rt.tambah_warga.create', compact('rts', 'rws', 'provinsi', 'kota', 'kecamatan', 'kelurahan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rt.tambah_warga.create')->with('success', 'Data penduduk berhasil ditambahkan.');
    }
...
public function edit($id)
{
    ...
    return view('pages.rt.tambah_warga.create', compact('data','rts', 'rws', 'provinsi', 'kota', 'kecamatan', 'kelurahan'));
}
