...
class MasterController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.rt.master-data.index', [
            "warga" => $warga,
    ...
    public function create()
    {
        ...
        return view('pages.rt.master-data.create', compact('rts', 'rws', 'provinsi', 'kota', 'kecamatan', 'kelurahan'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rt.master-data.index')->with('success', 'Data penduduk berhasil ditambahkan.');
    }

    public function show($id)
    {
        $warga = Warga::findOrFail($id);
        return view('pages.rt.master-data.detail', ['warga' => $warga]);
    }
...
public function edit($id)
{
    ...
    return view('pages.rt.master-data.edit', compact('data','rts', 'rws', 'provinsi', 'kota', 'kecamatan', 'kelurahan'));
}
...
public function update(Request $request, $id)
{
    ...
    return redirect()->route('rt.master-data.index')->with('success', 'Data penduduk berhasil diupdate');
}
